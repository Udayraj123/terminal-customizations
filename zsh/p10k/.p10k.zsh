...
# Greens
OWN_THEME_GREEN_0=22
OWN_THEME_GREEN_1=28
OWN_THEME_GREEN_2=34
OWN_THEME_GREEN_3=40
OWN_THEME_GREEN_4=46
OWN_THEME_GREEN_5=16
...
# All color values - https://github.com/romkatv/powerlevel10k/blob/master/README.md#set-colors-through-powerlevel10k-configuration-parameters
...
# All Glyphs - https://github.com/ryanoasis/powerline-extra-symbols#glyphs
  # Separator between same-color segments on the left.
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR=''
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR=''
  # Separator between different-color segments on the left.
  typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR='\uE0B0' # '\UE0C0'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=$OWN_THEME_BLUE_1
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=$OWN_THEME_BLUE_1
  ...
  typeset -g POWERLEVEL9K_RAM_BACKGROUND=$OWN_THEME_BLUE_4 #'#fbcaa9'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$OWN_THEME_BLUE_1 #'#b98654'
  ...
  function prompt_2_word_quote() {
    # source: https://www.laughteronlineuniversity.com/two-word-quotes/
    local randomMsgs=("Going Good!","You're Awesome!", "Accept yourself", "Act justly", "Aim high", "Alive & well", "Amplify hope", "Baby steps", "Be awesome", "Be colorful", "Be fearless", "Be honest", "Be kind", "Be spontaneous", "Be still", "Be yourself", "Beautiful chaos", "Breathe deeply", "But why?", "Call me", "Carpe diem", "Cherish today", "Chill out", "Come back", "Crazy beautiful", "Dance today", "Don’t panic", "Don’t stop", "Dream big", "Dream bird", "Enjoy life", "Enjoy today", "two word quoteEverything counts", "Explore magic", "Fairy dust", "Fear not", "Feeling groowy", "Find balance", "Follow through", "For real", "Forever free", "Forget this", "Friends forever", "Game on", "Getting there", "Give thanks", "Good job", "Good vibration", "Got love?", "Hakuna Matata", "Happy endings", "Have faith", "Have patience", "Hello gorgeous", "Hold on", "How lovely", "I can", "I remember…", "I will", "Imperfectly perfect", "Infinite possibilities", "Inhale exhale", "Invite tranquility", "Just because", "Just believe", "Just imagine", "Just sayin…", "Keep calm", "Keep going", "Keep smiling", "Laugh today", "Laughter heals", "Let go", "Limited edition", "Look up", "Look within", "Loosen up", "Love endures", "Love fearlessly", "Love you", "Miracle happens", "Move on", "No boundaries", "Not yet", "Notice things", "Oh snap", "Oh, really?", "Only believe", "Perfectly content", "Perfectly fabulous", "Pretty awesome", "Respect me", "Rise above", "Shift happens", "Shine on", "Sing today", "Slow down", "Start living", "Stay beautiful", "Stay focused", "Stay strong", "Stay true", "Stay tuned", "Take chances", "Thank you", "Then when?", "Think different", "Think first", "Think twice", "Tickled pink", "Treasure today", "True love", "Trust me", "Try again", "Unconditional love", "Wanna play?", "What if?", "Why not?", "Woo hoo!", "You can", "You matter", "You sparkle")
    local size=${#randomMsgs[@]}
...
function prompt_git_credential_helper(){
  ...
  function prompt_git_push_remote() {
    ...
    local isGit;
    if isGit=$(git rev-parse --is-inside-work-tree 2> /dev/null); then
      if pushRef=$(git rev-parse --symbolic-full-name --abbrev-ref @{push}  2> /dev/null); then 
        local git_push_remote=$(echo "$pushRef" | cut -f 1 -d/);
        # '#ca998a'
        # '#ebaa99'
        p10k segment -b "$OWN_THEME_BLUE_3" -f black -i '🚀' -t "$git_push_remote"
      else 
        p10k segment -b '#f0be3d' -f black -i '🚀' -t "Not Pushed"
      fi
    else
        prompt_2_word_quote
    fi 
